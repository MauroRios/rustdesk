...
lazy_static::lazy_static! {
    ...
    pub static ref BUILTIN_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut m: HashMap<String, String> = Default::default();
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["177.234.144.58"];
pub const RS_PUB_KEY: &str = "LelH+bqBrPDqMcboeR7CPJxYDylmWkTZqGpN8yyB4Yw=";
...
impl Config {
    ...
    pub fn get_rendezvous_server() -> String {
        let mut rendezvous_server = RENDEZVOUS_SERVERS[0].to_owned();
